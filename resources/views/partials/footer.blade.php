        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
                ...
                <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                    <li>
                        <a href="https://whas.me/pGKAFK57oe" rel="noreferrer" target="_blank"
                    ...
                    <li>
                        <a href="https://www.instagram.com/gunungsembungputra/profilecard/?igsh=MThyczNpY2ZqZG5sZw=="
                            rel="noreferrer" target="_blank" class="text-red-700 transition hover:text-red-700/75">
                    ...
                    <li>
                        <a href="mailto:gunungsembungputra13@gmail.com" rel="noreferrer" target="_blank"
                            class="text-red-700 transition hover:text-red-700/75">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                ...
                <div class="text-center sm:text-left">
                    ...
                    <ul class="mt-8 space-y-4 text-sm">
                        ...
                        <li>
                            <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Diskusi Harga
                            </a>
                        </li>

                        <li>
                            <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Layanan Pelanggan
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="mt-12 border-t border-gray-100 pt-6">
            <div class="text-center sm:flex sm:justify-between sm:text-left">
                <p class="text-sm text-gray-500">
                    ...
                    <a class="inline-block text-red-600 underline transition hover:text-red-600/75" href="#">
                        Terms & Conditions
                    </a>
