...
<style>
    ...
    .swiper-button-next {
        right: 30px;
        /* Jarak dari sisi kanan carousel */
    }

    .swiper-button-prev {
        left: 30px;
        /* Jarak dari sisi kiri carousel */
    }

    /* Kontainer swiper agar posisinya relatif untuk penempatan tombol */
    .swiper-container {
        position: relative;
        /* Agar tombol navigasi bisa diposisikan secara absolut dalam kontainer */
    }
...
<!-- Section 2 -->
<section class="relative px-2 py-32 bg-cover bg-center bg-no-repeat"
    style="background-image: url('{{ asset('hero-img/Bis1.jpg') }}');">
            ...
            <div class="w-full md:w-1/2 md:px-3">
                <div
                    ...
                    <p class="mx-auto text-stone-50 sm:max-w-md lg:text-xl md:max-w-3xl backdrop-blur-sm">
                        Kami Menyewakan Bis Pariwisata AC dan Non AC dengan harga yang terjangkau dan pelayanan yang
                    ...
                    <div class="swiper-container h-80">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset('hero-img/BisStuck.jpg') }}" alt="Image 1"
