    ...
    <section id="sejarah" class="bg-white p-8 rounded-lg pt-20">
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-6">
            ...
            <div class="lg:w-1/2 text-gray-700 space-y-6">
                ...
                <p class="text-lg text-justify leading-relaxed">
                    Sejak didirikan pada tahun <strong class="font-bold">2000</strong>, kami telah berkomitmen untuk
                    memberikan layanan transportasi berkualitas tinggi dengan fokus utama pada <strong
                        class="font-bold">keamanan</strong>,
                    <strong class="font-bold">kenyamanan</strong>, dan <strong class="font-bold">kepuasan anda</strong>.
                    Dengan pengalaman lebih dari <strong class="font-bold">30 tahun</strong>, kami telah melayani ratusan
                    pelanggan
                    di lebih dari <strong class="font-bold">50 kota</strong> dan destinasi di seluruh <strong
                        class="font-bold">Sumatra, Jawa Barat, Bali, Madura dan Sekitarnya</strong>.
                    Kami menyediakan berbagai pilihan armada, yang dapat disesuaikan dengan kebutuhan perjalanan, dengan
                    harga yang fleksibel untuk memenuhi berbagai anggaran anda.
                    Armada kami selalu terawat dengan baik, memastikan setiap perjalanan berlangsung dengan aman dan nyaman.
                    Percayakan kebutuhan transportasi anda kepada kami, dan nikmati perjalanan yang terpercaya dengan
                    <strong class="font-bold">harga yang kompetitif</strong>.
                </p>
                <p class="text-lg text-justify leading-relaxed">
                    Kami berlokasi di Cibiru, Bandung. Tepatnya di Jl. Cinunuk No. 126, Kabupaten Bandung, <strong
                        class="font-bold">siap melayani Anda kapan saja!</strong>
                </p>
        ...
        <div class="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
            ...
            <div class="flex flex-col items-center space-y-2">
                <h3 class="text-2xl font-semibold text-red-500">335+</h3>
            ...
            <div class="flex flex-col items-center space-y-2">
                <h3 class="text-2xl font-semibold text-red-500">250+</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white shadow-lg rounded-lg p-6 text-center">
                    ...
                    <p class="text-sm text-gray-500 mt-2">
                        Armada modern dengan fasilitas lengkap seperti Wi-Fi, AC, Audio (TV dan karaoke), dan kenyamanan
                        lainnya untuk perjalanan anda
                    </p>
                </div>
                <!-- Keunggulan  -->
                <div class="bg-white shadow-lg rounded-lg p-6 text-center">
                    ...
                    <p class="text-sm text-gray-500 mt-2">
                        Jangkauan rute luas ke berbagai kota dan destinasi populer di Jawa Barat, Sumatra, Bali, dan
                        sekitarnya
                    </p>
                </div>
                <!-- Keunggulan  -->
                <div class="bg-white shadow-lg rounded-lg p-6 text-center">
                    ...
                    <p class="text-sm text-gray-500 mt-2">
                        Nikmati perjalanan nyaman dengan sewa bus fleksibel sesuai anggaran anda. Harga yang bisa
                        disesuaikan, solusi transportasi terbaik tanpa khawatir biaya
                    </p>
                </div>
